...
create view employee_view as select emp_name ,department from employees ;
...
update employee_view set emp_name='Yaseen' where emp_name='Rahul Sharma';

delete from  employee_view where emp_name='Yaseen';
